      ...
      <div className="container-fluid">
        ...
        <header className="header">
          ...
          <div className="header__buttons">
            <a href="register.html"><button type="button" className="btn header__btn">Registrarse</button></a>
            <a href="login.html"><button type="button" className="btn header__btn">Iniciar sesión</button></a>
          </div>
        </header>
